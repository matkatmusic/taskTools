// Matrix 3 block reset, none shape, part 2: resets second half of pipeline blocks to their packet's rewind point.
...
const TASK_NUMBER = 9001;
const SUBMODULE_PATHS: string[] = [];

test("test_resetTask_atEveryBlock_none_restoresRootToThatBlocksRewindPoint", async () => {
    const fixture = makeShapeFixture("none", "behind-head", TASK_NUMBER);
