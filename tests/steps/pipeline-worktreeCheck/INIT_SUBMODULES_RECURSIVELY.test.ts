// Behavioral checks for scripts/steps/pipeline-worktreeCheck/INIT_SUBMODULES_RECURSIVELY.ts,
// ported from tests/initTaskSubmodules.test.ts. Mutating: exercised only against temp git repos.
