// Behavioral checks for scripts/steps/pipeline-worktreeCheck/TAKE_WORKTREE_LEASE.ts, ported from
// tests/createTaskWorktree.test.ts's state-recording assertion. Mutating: exercised only against temp git repos.
