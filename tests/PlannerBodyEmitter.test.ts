...
// ponytail: only the read-only exits are covered. The paths past "claim the task" create
// worktrees and write tasks.json, so they need a fixture repo, not this one.
