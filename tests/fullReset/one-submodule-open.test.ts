// Full reset of a spawned-but-never-merged task on the "one-submodule" repo shape.
...
test("test_fullReset_open_oneSubmodule_removesTheSpawnFromRootAndSubmoduleWithoutTouchingStaging", async () => {
