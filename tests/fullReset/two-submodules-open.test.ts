// Full reset of a spawned-but-never-merged task on the "two-submodules" repo shape (sibling submodules).
...
test("test_fullReset_open_twoSubmodules_removesTheSpawnFromEveryRepoWithoutTouchingStaging", async () => {
