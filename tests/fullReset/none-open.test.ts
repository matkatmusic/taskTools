// Full reset of a spawned-but-never-merged task on the "none" repo shape (root only, no submodules).
...
test("test_fullReset_open_none_removesTheSpawnWithoutTouchingStaging", async () => {
