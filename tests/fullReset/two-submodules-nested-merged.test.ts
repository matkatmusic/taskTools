// Full reset of a merged-and-closed task on the "two-submodules-nested" repo shape undoes the merge in every repo.
...
test("test_fullReset_merged_twoSubmodulesNested_undoesTheMergeBackToTheRecordedResetPointEverywhere", async () => {
    ...
    commitWorktreeWork(worktree, submodulePathsByShape["two-submodules-nested"]);
