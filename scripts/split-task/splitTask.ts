import { findTask, readTaskLists } from "../shared/getTaskDetails.ts";
import { closeTasks, type CloseTasksResult } from "../close-tasks/closeTasks.ts";
import type { TaskRecord } from "../shared/taskFiles.ts";
import { TASK_IS_NOT_OPEN, TASK_IS_OPEN } from "../shared/resultCodes.ts";
