...
const extractOpenSectionsPath = fileURLToPath(new URL("./extractOpenSections.ts", import.meta.url));
...
const archiveProcessedPath = fileURLToPath(new URL("./archiveProcessed.ts", import.meta.url));
