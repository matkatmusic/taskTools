...
export const reviewPlanRulingScriptPath = fileURLToPath(new URL("./planReviewRuling.ts", import.meta.url));
...
\`node ${reviewPlanRulingScriptPath} ${plan} <the number of fixes>\`
