...
import { resolveTaskWorktreeConventionDirectory, type PreparedGroup } from "../shared/prepareTasks.ts";
import { collectRepositorySources, currentBranchName } from "../shared/repositoryBranches.ts";
...
import { runMergePipeline } from "../shared/mergePipeline.ts";
import type { MergeOutcome } from "../shared/mergePipeline.ts";
import { discoverRepositoryTree } from "../shared/repositoryDiscovery.ts";
import type { DiscoveryManifest } from "../shared/repositoryDiscovery.ts";
import type { RepositoryOccurrence } from "../shared/repositoryManifest.ts";
import { discoverTestPolicy } from "../shared/testPolicy.ts";
import type { ResolutionManifest, ResolutionRequest } from "../shared/resolutionRequests.ts";
import { REBASE_IN_PROGRESS, REBASE_NOT_IN_PROGRESS, REF_PRESENT, REF_ABSENT } from "../shared/resultCodes.ts";
