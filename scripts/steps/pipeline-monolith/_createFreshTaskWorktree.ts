...
// ported from createTaskWorktree.ts minus its F11 journal/rollback wrapper.
// ponytail: no journal-based rollback across process boundaries; a mid-step crash throws
// and leaves a partial worktree for a human to clean up. Add the journal back if a run-step
// block ever needs to recover one automatically.
...
import { configureGeneratedArtifactIsolation } from "../../tackle-tasks/writeTaskBrief.ts";
