...
import { closeTasks } from "../../close-tasks/closeTasks.ts";
import { PATH_TRACKED_AT_HEAD, PATH_NOT_TRACKED_AT_HEAD, OCCURRENCE_COMMIT_SUCCEEDED, OCCURRENCE_COMMIT_FAILED } from "../../shared/resultCodes.ts";
...
if ${worktreePath(t, 'scripts/hooks/relatedTests.ts')} exists:
