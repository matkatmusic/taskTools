...
function makeClaimedProjectRoot(taskNumber: number, passed: boolean): string {
...
test("test_main_choosesCodexReviewsTestsWhenPassed", () => {
    const root = makeClaimedProjectRoot(1, true);
...
test("test_main_choosesAre2TestFixesDoneWhenRed", () => {
    const root = makeClaimedProjectRoot(2, false);
