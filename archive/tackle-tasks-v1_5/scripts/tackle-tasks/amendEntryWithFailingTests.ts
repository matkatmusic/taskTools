// "amend tasks.json entry with the failing tests" — pipeline-taskTests.mmd. Migrated to
// scripts/tackle-tasks/amendEntryWithFailingTestsImpl.ts (shared with
// scripts/steps/pipeline-taskTests/AMEND_ENTRY_WITH_FAILING_TESTS.ts). This file stays as the old
// CLI entrypoint, still dispatched by path from ImplementBodyEmitter.ts.
import { getCurrentTaskRun } from "./taskRunState.ts";
import { logStepOutput } from "./logStepOutput.ts";
export { type AmendEntryInput, type AmendEntryOutput, amendEntryWithFailingTests } from "./amendEntryWithFailingTestsImpl.ts";
import { amendEntryWithFailingTests } from "./amendEntryWithFailingTestsImpl.ts";
...
const AMEND_ENTRY_WITH_FAILING_TESTS_SOURCE = "scripts/tackle-tasks/amendEntryWithFailingTestsImpl.ts:14: amendEntryWithFailingTests";
