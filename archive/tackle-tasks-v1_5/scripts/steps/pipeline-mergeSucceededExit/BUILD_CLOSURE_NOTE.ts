// BUILD_CLOSURE_NOTE, from pipeline-mergeSucceededExit.mmd
// "build the closure note from the recorded run". Read-only: deterministic from the stored run
// record, so it runs correctly after CLEAN_UP_WORKTREES has already deleted the worktree.
