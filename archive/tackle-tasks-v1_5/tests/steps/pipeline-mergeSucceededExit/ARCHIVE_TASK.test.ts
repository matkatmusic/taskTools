// Behavioral checks for scripts/steps/pipeline-mergeSucceededExit/ARCHIVE_TASK.ts.  Ported from tests/closeTaskRun.test.ts.
...
import { main } from "../../../scripts/steps/pipeline-mergeSucceededExit/ARCHIVE_TASK.ts";
...
const TEMPLATE_PATH = join(
    dirname(fileURLToPath(import.meta.url)), "../../../scripts/steps/pipeline-mergeSucceededExit/ARCHIVE_TASK.template.json",
);
