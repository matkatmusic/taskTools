// Behavioral checks for scripts/steps/pipeline-mergeSucceededExit/MARK_TASK_INACTIVE_SUCCESS.ts.  Ported from tests/markTaskInactive.test.ts.
...
import { main } from "../../../scripts/steps/pipeline-mergeSucceededExit/MARK_TASK_INACTIVE_SUCCESS.ts";
...
const TEMPLATE_PATH = join(
    dirname(fileURLToPath(import.meta.url)), "../../../scripts/steps/pipeline-mergeSucceededExit/MARK_TASK_INACTIVE_SUCCESS.template.json",
);
