...
REVIEW_FILE=/tmp/fake-worktree/plans/test-review.json
...
Run `node /Users/matkatmusicllc/Programming/taskTools-86/scripts/tackle-tasks/shared/writeReviewAnswer.ts "<the outcome.payload path>" /tmp/fake-worktree/plans/test-review.json`.
