...
You are writing an implementation plan for task 164 from `.taskTools/tasks.json`.
...
```
/read-file "/Users/matkatmusicllc/Programming/taskTools/plans/brief-164.md" "/Users/matkatmusicllc/Programming/taskTools/scripts/hooks/stage-and-summarize-stop.ts" "/Users/matkatmusicllc/Programming/taskTools/scripts/shared/stagedDiffs.ts" "/Users/matkatmusicllc/Programming/taskTools/tests/stage-and-summarize-stop.test.ts" "/Users/matkatmusicllc/.claude/guides/planning.md" "/Users/matkatmusicllc/.claude/guides/tdd.md" "/Users/matkatmusicllc/Programming/taskTools/plans/plan-template.json"
```
...
Unit test on the hook: create a temp git repo, write and `git add` a file, feed scripts/stage-and-summarize-stop.ts its Stop-hook JSON on stdin (with a turn-flag file listing that path), and assert the printed hookSpecificOutput.additionalContext contains the staged diff text for that file.
