...
You are a second, independent codex instance auditing the implementation plan for task 196, drafted by another codex instance.
...
- /Users/matkatmusicllc/Programming/taskTools/plans/brief-196.md
- /Users/matkatmusicllc/Programming/taskTools/plans/plan.json
- /Users/matkatmusicllc/Programming/taskTools/diagrams/tackle-tasks/pipeline-preambleStatusCheck.mmd
- /Users/matkatmusicllc/Programming/taskTools/scripts/tackle-tasks/diagram-steps.json
- /Users/matkatmusicllc/Programming/taskTools/scripts/tackle-tasks/shared/runFullSuite.ts
- /Users/matkatmusicllc/Programming/taskTools/scripts/tackle-tasks/shared/writeTaskExitNotes.ts
- /Users/matkatmusicllc/Programming/taskTools/scripts/tackle-tasks/shared/taskRunState.ts
- /Users/matkatmusicllc/Programming/taskTools/tests/tackleTasksAcceptance.test.ts
- /Users/matkatmusicllc/Programming/taskTools/scripts/tackle-tasks/generateSteps.ts
- /Users/matkatmusicllc/Programming/taskTools/plans/review-plan-template.json

## SIBLING AND BLOCKER SCOPE

No other open task shares files with task 196.

No open task blocks task 196.

Task 196 blocks no open task.

Work assigned to a named sibling or blocker above is out of scope for task 196 and must not be reported as an omission.
...
Return only JSON in the shape given by `/Users/matkatmusicllc/Programming/taskTools/plans/review-plan-template.json`, which you read above, replacing every <...> with a real value.
...
The command that runs you captures that message to `/Users/matkatmusicllc/Programming/taskTools/plans/codex-review.json`.
Do not try to write the file yourself.

REVIEWEOF
)
REVIEW_FILE=/Users/matkatmusicllc/Programming/taskTools/plans/codex-review.json
CODEX_LOG=/Users/matkatmusicllc/Programming/taskTools/plans/prompt-shapes/task-196/codex-review.log

perl -e 'alarm shift; exec @ARGV' 300 \
  codex exec \
    -m gpt-5.6-terra -c 'model_reasoning_effort="medium"' \
    -s read-only \
    --output-schema /Users/matkatmusicllc/Programming/taskTools/plans/review-plan-schema.json \
    -o "$REVIEW_FILE" \
    "$REVIEW_PROMPT" \
...
Run `node /Users/matkatmusicllc/Programming/taskTools/scripts/tackle-tasks/shared/writeReviewAnswer.ts "<the outcome.payload path>" /Users/matkatmusicllc/Programming/taskTools/plans/codex-review.json`.
Run it even when the codex command failed or /Users/matkatmusicllc/Programming/taskTools/plans/codex-review.json does not exist; it records that failure for you.
